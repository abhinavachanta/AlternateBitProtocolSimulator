...
template <typename TIME>
    class Subnet
    {
        using definitions = subnet_defs; // putting definitions in context
        public:
        ...
        state_type state;
        // ports definition
        using input_ports = std::tuple <typename definitions:: in> ;
        using output_ports = std::tuple <typename definitions::out> ;
