...
class Subnet{
    ...
    */
    ...
    /**
    * structure state_type definition and declaring packet,index
    * and transmiting values
    */
    ...
    */
	...
	/** 
    * friend is a type grant member-level access to functions to return
    * output is index and transmitting to ostring stream.
    * @param os osstring stream
    * @param i strucutre state_type
